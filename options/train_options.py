...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--display_id', type=int, default=1, help='window id of the web display') #close it , original set to 1
        ...
        parser.add_argument('--gan_mode', type=str, default='vanilla', help='the type of GAN objective. [vanilla| lsgan | wgangp | perceptual]. vanilla GAN loss is the cross-entropy objective used in the original GAN paper.')
